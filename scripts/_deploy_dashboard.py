...
files_to_upload = [
    ('app/Controllers/DashboardController.php', f'{FTP_ROOT}/app/Controllers/DashboardController.php'),
    ('app/Models/Appointment.php', f'{FTP_ROOT}/app/Models/Appointment.php')
]
